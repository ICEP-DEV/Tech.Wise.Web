  ...
  return (
    <div>
      <div className="px-4 py-5 my-5 text-center">
        <img className="d-block mx-auto mb-4" src={assets.logo} alt="" width="200" height="80" />
      ...
      <div className="p-5 text-center bg-body-tertiary rounded-3">
        ...
        <h1 className="text-body-emphasis">About Nthome</h1>
      ...
      <div className="container px-4 py-5" id="featured-3">
        <h2 className="pb-2 border-bottom">Why Choose Nthome?</h2>
