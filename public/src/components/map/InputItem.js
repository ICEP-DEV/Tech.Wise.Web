  ...
  return (
    <div className='position-relative'>
      <div className='d-flex align-items-center'>
        ...
        {searchTerm && (
          <button className="btn btn-primary bg-black btn-sm  shadow-sm" onClick={handleClear}>
      ...
      {suggestionsVisible && (
        <div className='position-absolute top-full bg-white border border-gray-300 mt-1 max-h-40 overflow-y-auto shadow-lg rounded z-1'>
